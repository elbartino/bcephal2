...
namespace Misp.Planification.Diagram
{
    public class DiagramCanvas : DiagramDesigner.DesignerCanvas
    {
        ...
        protected override void initContextMenu()
        {
            ...
            ((DesignerContextMenu)this.ContextMenu).ObjectMenuItem.Header = "Add Loop";
            ...
            ((DesignerContextMenu)this.ContextMenu).ValueChainMenuItem.Header = "Add Action";
            ((DesignerContextMenu)this.ContextMenu).ValueChainMenuItem.Icon = new System.Windows.Controls.Image
            {
                Source = new BitmapImage(new Uri("Images/Action.png", UriKind.Relative))
            };
        }
