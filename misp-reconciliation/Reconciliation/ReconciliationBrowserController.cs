...
{
    public class ReconciliationBrowserController : BrowserController<Misp.Kernel.Domain.ReconciliationTemplate, BrowserData>
    {

        public ReconciliationBrowserController() 
        {
        ...
        { 
            return ReconciliationFunctionalitiesCode.RECONCILIATION_FILTERS_FUNCTIONALITY; 
        }
        ...
        { 
            return new ReconciliationBrowser(); 
        }
        ...
        {
            return (ReconciliationService)Service;
        }
