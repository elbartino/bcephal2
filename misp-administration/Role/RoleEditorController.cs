...
{
    public class RoleEditorController : EditorItemController<Misp.Kernel.Domain.Role>
    {
        ...
        {
            this.Functionality = FunctionalitiesCode.ADMINISTRATION_LIST_ROLE;
        }
        ...
        public RoleEditorItem getRoleEditor()
        {
            return (RoleEditorItem)this.View;
        }

        /// <summary>
        /// Service pour acceder aux opérations liés aux roles.
        /// </summary>
        /// <returns>RoleService</returns>
        public RoleService GetRoleService()
        {
            return (RoleService)base.Service;
        }
        ...
        public override OperationState Search()
        {
            ...
            Kernel.Domain.Role newRoot = GetRoleService().getRootRole();
            getRoleEditor().EditedObject = root;
            getRoleEditor().ListChangeHandler = root.childrenListChangeHandler;
            getRoleEditor().displayObject();
        ...
        protected override IView getNewView() { return new RoleEditorItem(); }
        ...
        protected override Kernel.Ui.Base.ToolBar getNewToolBar() { return new RoleToolBar(); }
        ...
        protected void onAddRole(object sender, AddingNewItemEventArgs e) 
        {
        ...
        protected void onCellEditEnding(object sender, DataGridCellEditEndingEventArgs e)
        {
            ...
            Kernel.Domain.Role r = (Kernel.Domain.Role)row.Item;
            if (r != null)
            {
        ...
        protected void onRoleNameChange(object sender, DataGridRowEditEndingEventArgs e) 
        {
            DataGridRow row = e.Row;
            Kernel.Domain.Role r = (Kernel.Domain.Role)row.Item;
            if (r != null) 
