...
namespace Misp.Sourcing.InputGrid
{
    public class InputGridBrowserController : BrowserController<Grille, BrowserData>
    {
        ...
        /// L'éditeur.
        /// </summary>
        public override string GetEditorFuntionality() { return Misp.Sourcing.Base.SourcingFunctionalitiesCode.NEW_INPUT_GRID_FUNCTIONALITY ; }
        
        /// <summary>
        /// Crée et retourne une nouvelle instance de la vue gérée par ce controller.
        /// </summary>
        /// <returns>Une nouvelle instance de la vue</returns>
        protected override IView getNewView() { return new InputGridBrowser(); }
