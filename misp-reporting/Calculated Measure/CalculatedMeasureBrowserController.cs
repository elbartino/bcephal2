...
{
    class CalculatedMeasureBrowserController : BrowserController<Misp.Kernel.Domain.CalculatedMeasure, BrowserData>
    {
        ...
        protected override IView getNewView() { return new CalculatedMeasureBrowser(this.SubjectType, this.FunctionalityCode); }
