...
{
    class CalculatedMeasureBrowser : Browser<BrowserData>
    {


        public CalculatedMeasureBrowser(Kernel.Domain.SubjectType subjectType, String functionality) : base(subjectType, functionality) { }
