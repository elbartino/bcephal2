...
{
    public class AdvisementToolBar : Misp.Kernel.Ui.Base.ToolBar
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        protected override void userConfiguration()
        {
            ...
            NewButton.ToolTip = "Add a new Advisement";
            SaveButton.ToolTip = "Save Advisement";
            CloseButton.ToolTip = "Exit Advisement Editor";
