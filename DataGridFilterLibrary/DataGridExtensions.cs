...
namespace DataGridFilterLibrary
{
    public class DataGridExtensions
    {
        ...
        public static DependencyProperty IsSupportListTypeProperty =
            DependencyProperty.RegisterAttached("IsSupportListType",
                typeof(bool), typeof(DataGrid));

        public static bool GetIsSupportListType(DependencyObject target)
        {
            return (bool)target.GetValue(IsSupportListTypeProperty);
        }

        public static void SetIsSupportListType(DependencyObject target, bool value)
        {
            target.SetValue(IsSupportListTypeProperty, value);
        }



        public static DependencyProperty FilterHandlerProperty =
            DependencyProperty.RegisterAttached("FilterHandler",
                typeof(FilterHandler), typeof(DataGrid));

        public static FilterHandler GetFilterHandler(DependencyObject target)
        {
            return (FilterHandler)target.GetValue(FilterHandlerProperty);
        }

        public static void SetFilterHandler(DependencyObject target, FilterHandler value)
        {
            target.SetValue(FilterHandlerProperty, value);
        }


        public static DependencyProperty FilterDatasProperty =
            DependencyProperty.RegisterAttached("FilterDatas",
                typeof(FilterDatas), typeof(DataGrid));

        public static FilterDatas GetFilterDatas(DependencyObject target)
        {
            return (FilterDatas)target.GetValue(FilterDatasProperty);
        }

        public static void SetFilterDatas(DependencyObject target, FilterDatas value)
        {
            target.SetValue(FilterDatasProperty, value);
        }
