...
{
    public class ReconciliationTemplateService : Service<Misp.Kernel.Domain.ReconciliationTemplate, Misp.Kernel.Domain.Browser.BrowserData>
    {
        #region Properties
        ...
        public ReconciliationTemplateService()
        {
