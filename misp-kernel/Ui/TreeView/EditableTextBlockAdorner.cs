...
namespace Misp.Kernel.Ui.TreeView
{
    ...
    public class EditableTextBlockAdorner : Adorner
    {
        ...
        {
            _textBox.Arrange(new Rect(0, 0, _textBlock.DesiredSize.Width + 55, _textBlock.DesiredSize.Height * 1.2));
            _textBox.Focus();
            return finalSize;
        }
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            drawingContext.DrawRectangle(null, new Pen
                ...
                Brush = Brushes.Gold,
                Thickness = 2
            }, new Rect(0, 0, _textBlock.DesiredSize.Width+55 , _textBlock.DesiredSize.Height));
        }
