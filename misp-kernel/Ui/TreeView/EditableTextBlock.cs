...
namespace Misp.Kernel.Ui.TreeView
{
    public class EditableTextBlock : TextBlock
    {
        ...
        public IHierarchyObject esss;
        public EditableTree treeTest;
        /// <summary>
        ...
        private void TextBoxKeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                EditableTree.valeurSelection.Text = text.Text;
                
                esss = esss.GetChildByName(text.Text);
               if(treeTest.IsNameInUse(esss))
                IsInEditMode = true;
                else
                IsInEditMode = false;
            }
        ...
        protected override void OnMouseDown(MouseButtonEventArgs e)
        {
            ...
            EditableTree.valeurSelection  = e.Source as EditableTextBlock;
        ...
        private  System.Windows.Controls.TreeView GetNearestContainer(UIElement element)
        {
            // Walk up the element tree to the nearest tree view item.
            System.Windows.Controls.TreeView container = element as System.Windows.Controls.TreeView;
            while ((container == null) && (element != null))
            {
                element = VisualTreeHelper.GetParent(element) as UIElement;
                container = element as System.Windows.Controls.TreeView;
            }
            return container;
        }
    }
