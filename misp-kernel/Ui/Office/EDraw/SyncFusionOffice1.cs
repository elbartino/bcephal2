...
{
    public partial class SyncFusionOffice1 : UserControl, ISpreadsheet
    {
    ...
    /// <summary>
        ...
        /// </summary>
         ...
         public SyncFusionOffice1()
        {
            InitializeComponent();
            Excel = excelEngine1.Excel;
        ...
        {
            if (this.Office.Excel.ActiveWorkbook != null ) this.Office.Excel.ActiveWorkbook.Close();
            //this.Office.Dispose();
            return OperationState.CONTINUE;
        }
