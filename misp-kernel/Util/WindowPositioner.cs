...
namespace Misp.Kernel.Util
{
    public static class WindowPositioner
    {
        ...
        public static bool ActivateCenteredToMouse(this Dialog window)
        {
            ComputeTopLeft(ref window);
            return window.Activate();
        }

        public static bool? ShowCenteredToMouse(this Dialog window)
        {
        ...
        public static bool? ShowCenteredToMouse(this Window window)
        {
            // in case the default start-up location isn't set to Manual
            WindowStartupLocation oldLocation = window.WindowStartupLocation;
            // set location to manual -> window will be placed by Top and Left property
        ...
        #region Methods
        private static void ComputeTopLeft(ref Dialog window)
        {
